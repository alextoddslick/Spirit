...
public class SpiritClient {
    ...
    public static void initClient() {
        ...
        ClientServices.CLIENT.registerItemProperty(SpiritItems.SOUL_BOW.get(),
                ResourceLocation.withDefaultNamespace("pull"), (itemStack, clientLevel, livingEntity, i) -> {
                    ...
                    return (float) (itemStack.getUseDuration(livingEntity) - livingEntity.getUseItemRemainingTicks())
                            / 20.0f;
                });
        ClientServices.CLIENT.registerItemProperty(SpiritItems.SOUL_BOW.get(),
                ResourceLocation.withDefaultNamespace("pulling"),
                (itemStack, clientLevel, livingEntity, i) -> livingEntity != null && livingEntity.isUsingItem()
                        && livingEntity.getUseItem() == itemStack ? 1.0f : 0.0f);
        ClientServices.CLIENT.registerItemProperty(SpiritItems.SOUL_CRYSTAL_SHARD.get(),
                ResourceLocation.fromNamespaceAndPath(Spirit.MODID, "filled"), MobCrystalItem::mobCrystalType);
    }
