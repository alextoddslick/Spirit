...
public record PedestalRecipe(ResourceLocation id, HolderSet<EntityType<?>> entityInput,
    ...
    public static Codec<PedestalRecipe> codec(ResourceLocation id) {
        return RecordCodecBuilder.create(instance -> instance.group(
                ...
                TagAndListSetCodec.of(BuiltInRegistries.ENTITY_TYPE).fieldOf("entityInput")
                        .forGetter(PedestalRecipe::entityInput),
                ...
                BuiltInRegistries.ENTITY_TYPE.byNameCodec().fieldOf("entityOutput")
