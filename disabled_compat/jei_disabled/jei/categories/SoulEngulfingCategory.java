...
public class SoulEngulfingCategory extends BaseCategory<SoulEngulfingRecipeWrapper> {
    ...
    public static final ResourceLocation GUI_BACKGROUND = ResourceLocation.fromNamespaceAndPath(Spirit.MODID,
            "textures/gui/soul_engulfing.png");
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(Spirit.MODID, "soul_engulfing");
    public static final RecipeType<SoulEngulfingRecipeWrapper> RECIPE = new RecipeType<>(ID,
            SoulEngulfingRecipeWrapper.class);
    ...
    public SoulEngulfingCategory(IGuiHelper guiHelper) {
        super(guiHelper,
                ...
                guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK,
                        SpiritItems.SOUL_CRYSTAL.get().getDefaultInstance()));
    ...
    @Override
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, SoulEngulfingRecipeWrapper wrapper,
        ...
        builder.addSlot(RecipeIngredientRole.OUTPUT, 133, 83).addIngredient(VanillaTypes.ITEM_STACK,
                recipe.getResultItem(RegistryAccess.EMPTY));
    }

    @Override
    public List<Component> getTooltipStrings(SoulEngulfingRecipeWrapper recipe, IRecipeSlotsView recipeSlotsView,
    ...
    @Override
    public void draw(SoulEngulfingRecipeWrapper recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics,
            double mouseX, double mouseY) {
        ...
        pose.get(floatBuffer);
        Vec3 translation = new Vec3(floatBuffer.get(12) * guiScale, floatBuffer.get(13) * guiScale,
                floatBuffer.get(14) * guiScale);
        RenderSystem.enableScissor((int) (translation.x + 2 * guiScale),
                (int) (Minecraft.getInstance().getWindow().getHeight() - 27 * guiScale - translation.y - 73 * guiScale),
                (int) (103 * guiScale), (int) (73 * guiScale));
        ...
        guiGraphics.pose().translate(52 - width, height, 100);
    ...
    @Override
    public boolean handleInput(SoulEngulfingRecipeWrapper recipe, double mouseX, double mouseY,
