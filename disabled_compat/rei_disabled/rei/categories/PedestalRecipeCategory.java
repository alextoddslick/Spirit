...
public class PedestalRecipeCategory implements DisplayCategory<PedestalDisplay> {
    public static final ResourceLocation GUI_BACKGROUND = ResourceLocation.fromNamespaceAndPath(Spirit.MODID, "textures/gui/soul_transmutation.png");
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(Spirit.MODID, "soul_transmutation");
